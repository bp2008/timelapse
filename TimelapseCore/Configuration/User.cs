...
namespace TimelapseCore.Configuration
{
	...
	public class User : FieldSettable
	{
		...
		[EditorHint("0 to 100.  A value of 0 means the user has no more rights than an anonymous user.  Currently, only an administrator (permission 100) has any rights.")]
